...
/**
 * Exception thrown by the JVM agent if a file blocking API is used.
...
public class FileReactiveAuditException extends ReactiveAuditException
{
	 ...
	 */
	public FileReactiveAuditException(Latency latency, String message)
	{
	 ...
	 */
	public FileReactiveAuditException(Latency latency, String format, Object... args)
	{
